                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-green-400">
                      {typeof stats.dailyCommission === 'number' ? (parseFloat(String(stats.dailyCommission || 0)) || 0).toFixed(2) : '0.00'} π
                    </p>
                  </div>
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-blue-400">
                      {typeof stats.totalCommission === 'number' ? (parseFloat(String(stats.totalCommission || 0)) || 0).toFixed(2) : '0.00'} π
                    </p>
                  </div>
